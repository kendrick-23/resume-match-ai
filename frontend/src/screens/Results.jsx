  ...
  return (
    <ScreenWrapper>
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        style={{ position: 'fixed', bottom: 60, left: 0, width: 120, pointerEvents: 'none', zIndex: 0, opacity: 0.85 }}
      />
      <img
        src="/ott/ott-corner-right.png"
        alt=""
        aria-hidden="true"
        style={{ position: 'fixed', bottom: 60, right: 0, width: 120, pointerEvents: 'none', zIndex: 0, opacity: 0.85 }}
      />
      </div>
    </ScreenWrapper>
  );
